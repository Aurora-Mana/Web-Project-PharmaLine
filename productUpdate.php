...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
    ...
    $update_data = "UPDATE products SET name=?, description=?, price=?, quantity=?, image=?, category=? WHERE id=?";
    $stmt = mysqli_prepare($conn, $update_data);
    mysqli_stmt_bind_param($stmt, "ssdissi", $product_name, $product_info, $product_price, $product_quantity, $product_image, $product_category, $id);
...
<div class="body-content">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="product_name" value="<?php echo $row['name']; ?>" placeholder="enter the product name" class="box" >
